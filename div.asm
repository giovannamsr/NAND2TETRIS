...
D=M              // RESTO
@RESTOA
D;JEQ           // VAI PARA RESTOA 
@1
D=M-D            // DENOMINADOR-RESTO em D
@3
M=D
@6
D=-M            // -QUOCIENTE em D
...
D=D-A
@2
M=D             // RETORNA (-QUOCIENTE-1, DENOMINADOR-RESTO)
@FIM
0;JMP
(RESTOA)
@3
...
D=-M              // -RESTO EM D
@RESTOB
D;JEQ           // VAI PARA RESTOB
@1
D=D-M            // DENOMINADOR-RESTO em D
@3
M=D
@6
D=M              // QUOCIENTE em D
...
D=D+1
@2
M=D             // RETORNA (QUOCIENTE+1, DENOMINADOR-R)
@FIM
0;JMP
(RESTOB)
@3
